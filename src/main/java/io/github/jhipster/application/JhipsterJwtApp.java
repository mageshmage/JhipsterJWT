...
public class JhipsterJwtApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterJwtApp.class);

    private final Environment env;

    public JhipsterJwtApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes JhipsterJWT.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterJwtApp.class);
